...
function executeOnEcwidAvailable(intervalMs) {
  ...
  function checkEcwidAvailability() {
    ...
    if (typeof window.Ecwid !== 'undefined') {
       if(Ecwid?.OnPageLoaded && !pageLoadedFound) {
        console.log('pageloaded module found, add handler to the loaded event!');
        Ecwid.OnPageLoaded.add(function () { console.log('handler added, call main!'); main(); });
  ...
  if(pageLoadedFound) clearInterval(intervalId);    
}
